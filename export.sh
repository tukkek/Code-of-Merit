...
/usr/bin/pandoc -s --from=markdown_mmd+yaml_metadata_block+smart --to=html -V css='css/default.css' --metadata pagetitle="$TITLE" -o $CKSUM.htm $SRC_MD
